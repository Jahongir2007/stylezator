...
### Off-canvas menu in stylezator 1.5.0 
```markdown
<!DOCTYPE html>
 <html>
  <head>
...
```
### Vertical menu in stylezator 1.5.0
```markdown
    <!DOCTYPE html>
      <html lang="en">
        <head>
...
```
### Button group in stylezator 1.5.0 
```markdown
<!DOCTYPE html>
 <html>
  <head>
...
```
### Vertical button group in stylezator 1.5.0 
```markdown
<!DOCTYPE html>
 <html>
  <head>
...
```
### Toggle Switch in stylezator 1.5.0 
```markdown
<!DOCTYPE html>
 <html>
  <head>
...
```
### Box and contents in stylezator 1.5.0 
```markdown
<!DOCTYPE html>
 <html>
  <head>
